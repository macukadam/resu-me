...
impl Default for GlobalState {
    fn default() -> Self {
        Self {
            ...
            job_description: "Software engineer with experience of developing products from ground up. A polyglot programmer. Very curious about new tech and languages. Curious about history, science, and art. Lifelong student.".to_string(),
            email: "ugurcan.akpulat@gmail.com".to_string(),
            website: "https://github.com/macukadam".to_string(),
            phone: "+31639695782".to_string(),
            work_experience: Experience::default_vec(),
            education: Experience::default_vec(),
    ...
    fn default_vec() -> Vec<Self> {
        vec![
            Self {
                ...
                explanation: "• Developing and maintaining of credit analysis platform of Swishfund.
• Developing and extending of our opensource PIPY packages.
• Implementing deployment and testing pipelines."
                    .to_string(),
            },
            Self {
                position: "Eleena - Software Engineer / October 2019 - December 2021".to_string(),
                explanation: "• Developing the back-end system for reading out thousands of DLMS/COSEM compatible smart energy meters using tornado framework. Reliably reading more than 20000 smart meters with minimum system requirements at industry leading speed.
• Developing customer management and reporting platforms with Django framework.
• Full stack development, devOps, test, design of new products, design of POC’s, database
management, maintaining some ML algorithms.
• Helping and leading other engineers. (Small team)
• Sharing knowledge learned every day and took full responsibility of the products."
                    .to_string(),
            },
            Self {
                position: "Siemens - Software Engineer / October 2017 - October 2019".to_string(),
                explanation: "• Maintaining and developing of Siemens general automation platform TIA portal.
• Developing new features and internal tools for controllers with C#.
• Implemented and maintained new features for prototypes of different PLC's such as
S7300 and S71500 family."
                    .to_string(),
            },
            Self {
                position: "Lambda Construction - Software Developer".to_string(),
                explanation: "• Designed ERP system of Lambda.
• Developed Lambda website and made seamless integration with the EPR system."
                    .to_string(),
            },
        ]
    }
    ...
    fn default_vec() -> Vec<Self> {
        vec![
            ...
            Self {
                ...
                link: "www.linkedin.com".to_string(),
            },
            Self {
                name: "Twitter".to_string(),
                link: "www.twitter.com".to_string(),
            }
        ]
    }
}
