...
pub fn nav() -> Html {
    ...
    let website = state.website.clone();
        ...
        <div class="container">
          <div class="row p-3">
            <div class="col-md pb-2 pb-md-0">
              ...
              <a href={format!("mailto:{}", email.clone())} class="text-white ml-2">{email}</a>
            </div>
            <div class="col-md text-md-center pb-2 pb-md-0">
              ...
              <a href={website.clone()} class="text-white ml-2">{website}</a>
            </div>
            <div class="col-md text-md-right">
              ...
              <a href={format!("tel:{}", phone.clone())} class="text-white ml-2">{phone}</a>
            </div>
          </div>
        </div>
      </nav>
